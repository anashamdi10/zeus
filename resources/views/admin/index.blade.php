                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group mb-0">
                            <input class="form-control input-1 digits" type="text" name="daterange" value="{{\Carbon\Carbon::now()->format('m/d/Y')}} - {{\Carbon\Carbon::now()->format('m/d/Y')}}">
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="card o-hidden border-0">
                    <div class="bg-secondary b-r-4 card-body">
                        <div class="media static-top-widget">
                            ...
                            <div class="media-body"><span class="m-0">{{ __('main.Payments') }}</span>
                ...
                <div class="card o-hidden border-0">
                    <div class="bg-primary b-r-4 card-body">
                        <div class="media static-top-widget">
                            ...
                            <div class="media-body"><span class="m-0">{{ __('main.Brands') }} </span>
                                <h4 class="mb-0 counter">{{$brands}}</h4><i class="icon-bg" data-feather="check-square"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card o-hidden border-0">
                    <div class="bg-secondary b-r-4 card-body">
                        <div class="media static-top-widget">
                            ...
                            <div class="media-body"><span class="m-0">{{ __('main.Slides') }}</span>
                                <h4 class="mb-0 counter">{{$slides}}</h4><i class="icon-bg" data-feather="image"></i>
                            </div>
                        </div>
                    </div>
                </div>
                      ...
                      <table class="table table-bordernone">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="font-primary">{{($shortage->available==1)?"available": "not available"}}</td>
                            <td>
                              <div
