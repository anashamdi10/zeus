...
<h3>Our News Edit / {{$info->title_en}} </h3>
@endslot
        ...
        <div class="col-sm-12 col-xl-12">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action={{route('news.update',$info->id)}} method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                {{method_field('PUT')}}
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" id="writer_en" value="{{$info->writer_en}}" type="text" name="writer_en">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <label class="col-form-label pt-0" for="title">Writer ar </label>
                                            <input class="form-control" id="writer_ar" value="{{$info->writer_ar}}" type="text" name="writer_ar">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <label class="col-form-label pt-0" for="title_ar">Date </label>
                                            <input class="form-control" value="{{$info->date}}" id="date" type="date" name="date">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group mb-3">
                                    <img src="{{ asset('uploads/news/' . $info->image) }}" width="80px" height="80px" style="margin-bottom: 10px; " /> <br>
