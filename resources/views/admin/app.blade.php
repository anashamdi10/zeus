...
<link href="https://cdn.jsdelivr.net/gh/hung1001/font-awesome-pro-v6@44659d9/css/all.min.css" rel="stylesheet" type="text/css" />
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('public/backend/css/armain.css') }}" />
    @yield('styles')
</head>
<body class="app sidebar-mini rtl">
  ...
  let csvButtonTrans = 'تصدير csv'
  let excelButtonTrans = 'تصدير excel'
  let pdfButtonTrans = 'تصدير pdf'
  let printButtonTrans = 'طباعة'
  let colvisButtonTrans = 'الاعمدة'
  let selectAllButtonTrans = 'تحديد الكل'
  let selectNoneButtonTrans = 'إلغاء'
