        ...
        <div class="col-sm-12 col-xl-12">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action={{route('categoryterms.update',$info->id)}} method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                {{method_field('PUT')}}
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="category_id" id="categories" class="form-control">
                                        ...
                                        <option value="{{ $category->id }}" {{($category->id == $info->category_id)?"selected":""}}>{{ $category->name_en }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group mb-3 ibox-content no-padding">
                                            ...
                                            <input class="form-control" type="text" value="{{$info->content_en}}" name="content_en">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group mb-3 ibox-content no-padding">
                                            ...
                                            <input class="form-control" type="text" value="{{$info->content_ar}}" name="content_ar">
