...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('zeus/assets/img/favicon.png')}}" rel="icon" />
  <!-- For Facebook -->
  ...
  <link href="{{asset('zeus/assets/css/style.css')}}" rel="stylesheet" />
  <!-- Vendor CSS Files -->
  <link href="{{asset('zeus/assets/vendor/aos/aos.css')}}" rel="stylesheet" />
  <link href="{{asset('zeus/assets/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet" />
  <link href="{{asset('zeus/assets/vendor/boxicons/css/boxicons.min.css')}}" rel="stylesheet" />
