...
<input type="hidden" id="ajax_subcategory" value="{{ route('sub_category_search') }}">
<input type="hidden" id="ajax_product" value="{{ route('product_search') }}">
<main id="main">
    <!-- ======= Breadcrumbs ======= -->
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <div class="px-4 mb-30">
                        ...
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            ...
                            <label class="custom-control-label" for="category-2">{{$category->name_en}}</label>
                        </div>
                        @endforeach
