                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content">
                            ...
                            <li>
                                <a class="<?php if(Route::current()->getName() == 'admin.why'): ?> active <?php endif; ?>" href="<?php echo e(route('admin.why')); ?>"><span>why_shose_us</span></a>
                            </li>
                            <li>
...
<!-- Page Sidebar Ends--><?php /**PATH C:\xampp\htdocs\zeus\resources\views/layouts/default-layout/partials/sidebar.blade.php ENDPATH**/ ?>