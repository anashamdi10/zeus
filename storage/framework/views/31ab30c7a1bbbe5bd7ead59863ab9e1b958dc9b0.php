                            ...
                            <form action=<?php echo e(route('slides.update',$info->id)); ?> method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3 ">
                                        ...
                                        <input class="form-control" value="<?php echo e($info->sub_title_ar); ?>" id="sub_title_ar" type="text" name="sub_title_ar">
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.default-layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/s2758queo60r/zeus-ex.com/resources/views/admin/slide/edit.blade.php ENDPATH**/ ?>