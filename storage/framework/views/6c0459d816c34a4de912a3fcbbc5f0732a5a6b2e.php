        ...
        <div class="col-sm-12 col-xl-12">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action=<?php echo e(route('certificates.update',$info->id)); ?> method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" id="title" type="text" name="title" value="<?php echo e($info->title); ?>">
                                    </div>
                                    <div class="col-md-6 mb-3 ">
                                        <label class="col-form-label pt-0" for="title_ar">title ar </label>
                                        <input class="form-control" id="title_ar" type="text" name="title_ar" value="<?php echo e($info->title_ar); ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class=" col-md-6 mb-3">
                                        <label class="col-form-label pt-0" for="city">city</label>
                                        <input class="form-control" id="sub_title" type="text" name="city" value="<?php echo e($info->city); ?>">
                                    </div>
                                    <div class="col-md-6 mb-3 ">
                                        <label class="col-form-label pt-0" for="title_ar">city_ar</label>
                                        <input class="form-control" id="city_ar" type="text" name="city_ar" value="<?php echo e($info->city_ar); ?>">
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.default-layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/s2758queo60r/zeus-ex.com/resources/views/admin/about/certificates_edit.blade.php ENDPATH**/ ?>