                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3 ibox-content no-padding">
                            <label class="col-form-label pt-0" for="name_en"> الوصف بالانجليزيه</label>
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3 ibox-content no-padding">
                            <label class="col-form-label pt-0" for="name_en"> الوصف بالعربيه</label>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-4">
                    ...
                    <div class="form-group mb-3 col-3">
                        <label class="col-form-label pt-0" for="name_en">اختر القسم</label>
                    ...
                    <div class="form-group mb-3 col-3">
                        <label class="col-form-label pt-0" for="name_en"> مميز</label>
                ...
                <div class="row mb-4">
                    <div class="form-group mb-3">
                        <label class="col-form-label pt-0" for="main_image">صورة الرئيسية </label>
                        <input class="form-control" id="main_full" name="main_full" type="file">
                    </div>
                    <div class="form-group mb-3">
                        <label class="col-form-label pt-0" for="main_image">صور المنتج </label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.default-layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\well_know\resources\views/admin/product/create.blade.php ENDPATH**/ ?>