<link href="<?php echo e(asset('assets/css/all-v6.css')); ?>" rel="stylesheet" type="text/css" />
<!-- ico-font-->
...
<link id="color" rel="stylesheet" href="<?php echo e(asset('assets/css/color-5.css')); ?>" media="screen">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/style-edit.css')); ?>">
<!-- Responsive css-->
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/responsive.css')); ?>">
<?php echo $__env->yieldPushContent('styles'); ?><?php /**PATH /home/s2758queo60r/zeus-ex.com/resources/views/layouts/default-layout/partials/css.blade.php ENDPATH**/ ?>