...
<section id="home-section" class="hero active">
            ...
            <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
                <div class="media block-6 services mb-md-0 mb-4">
                    ...
                    <div class="media-body">
                        <h3 class="heading">Best Product</h3>
                        <span>With best Price </span>
                    </div>
                </div>
            </div>
            <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
...
<section class="ftco-section ftco-category">
    <div class="container">
        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6 order-md-last align-items-stretch d-flex">
                        <div class="category-wrap-2 ftco-animate img align-self-stretch d-flex"
                            style="background-image: url(<?php echo e(asset('newpage/images/category.webp')); ?>)">
                    ...
                    <div class="col-md-6">
                        <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end"
                            style="background-image: url(<?php echo e(asset('newpage/images/category-1.webp')); ?>)">
                            <div class="text px-3 py-1">
                                <h2 class="mb-0"><a href="#">Formica panels</a></h2>
                            </div>
                        </div>
                        <div class="category-wrap ftco-animate img d-flex align-items-end"
                            style="background-image: url(<?php echo e(asset('newpage/images/category-2.webp')); ?>)">
                            <div class="text px-3 py-1">
            ...
            <div class="col-md-4">
                <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end"
                    style="background-image: url(<?php echo e(asset('newpage/images/category-3.webp')); ?>)">
                    <div class="text px-3 py-1">
                        <h2 class="mb-0"><a href="#">Woodyboard</a></h2>
                    </div>
                </div>
                <div class="category-wrap ftco-animate img d-flex align-items-end"
                    style="background-image: url(<?php echo e(asset('newpage/images/category-4.webp')); ?>)">
                    <div class="text px-3 py-1">
                        <h2 class="mb-0"><a href="#">Woodyboard</a></h2>
                    </div>
                </div>
                        ...
                        <div id="recipe-card__cover" class="recipe-card__cover">
                            <div class="recipe-card__img">
                                <img src="<?php echo e(asset('uploads/products/'. $product->image)); ?>"
                                    alt="woody-factory Products wooden boards" />
                            </div>
...
<section id="timersection" class="ftco-section img"
    style="background-image: url(<?php echo e(asset('uploads/offers/' . $flashs->image)); ?>)">
    <div class="overlay"></div>
    <div class="container">
        <div class="row justify-content-end">
            <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
                ...
                <input type="text" style="display: none;" value="<?php echo e($flashs->date_time); ?>" id='date_time'
                    name="date_time">
                    ...
                    <div class="item">
                        <div class="testimony-wrap p-4 pb-5">
                            <div class="user-img mb-5"
                                style="background-image: url(<?php echo e(asset('uploads/review/'. $info->image)); ?>)">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm ftco-animate">
                <a href="#" class="partner"> <img src="<?php echo e(asset('newpage/images/partner-1.png')); ?>" class="img-fluid"
                        alt="Woody factory parteners " /></a>
            </div>
            <div class="col-sm ftco-animate">
                <a href="#" class="partner"><img src="<?php echo e(asset('newpage/images/partner-2.png')); ?>" class="img-fluid"
                        alt="Woody factory parteners " /></a>
            </div>
            <div class="col-sm ftco-animate">
                <a href="#" class="partner"><img src="<?php echo e(asset('newpage/images/partner-3.png')); ?>" class="img-fluid"
                        alt="Woody factory parteners " /></a>
            </div>
            <div class="col-sm ftco-animate">
                <a href="#" class="partner"><img src="<?php echo e(asset('newpage/images/partner-4.png')); ?>" class="img-fluid"
                        alt="Woody factory parteners " /></a>
            </div>
            <div class="col-sm ftco-animate">
                <a href="#" class="partner"><img src="<?php echo e(asset('newpage/images/partner-5.png')); ?>" class="img-fluid"
                        alt="Woody factory parteners " /></a>
            </div>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('site.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\woody-factory\resources\views/site/pages/index.blade.php ENDPATH**/ ?>