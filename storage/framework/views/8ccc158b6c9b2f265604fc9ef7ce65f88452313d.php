...
<section class="ftco-section">
	...
	<div class="col-lg-6 product-details pl-md-5 ftco-animate">
			<div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper2 col-12">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<img src="<?php echo e(asset('uploads/products/'. $images->full)); ?>" />
					</div>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="modal-footer">
							...
							<button typbuttone="submit" class="btn btn-primary">Understood</button>
						</div>
					</form>
				</div>
			</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('site.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rltv764kemik/woody-factory.com/resources/views/site/pages/products_item.blade.php ENDPATH**/ ?>