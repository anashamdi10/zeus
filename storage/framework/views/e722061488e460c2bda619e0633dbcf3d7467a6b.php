        ...
        <div class="col-sm-12 col-xl-12">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action=<?php echo e(route('slides.video.update',$info->id)); ?> method="post" enctype="multipart/form-data">
                                ...
                                <video autoplay muted loop id="myVideo" style="height: 200px; width: 200px;">
                                    <source src="<?php echo e(asset('uploads/video')); ?>/<?php echo e($info['video']); ?>" type="video/mp4" />
                                </video>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.default-layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zeus-website\resources\views/admin/slide/edit_video.blade.php ENDPATH**/ ?>