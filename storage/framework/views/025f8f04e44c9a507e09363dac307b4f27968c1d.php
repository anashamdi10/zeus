            ...
            <form action=<?php echo e(route('order_create')); ?> method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" style="text-align: right">
                            <span><?php echo e($product->name_ar); ?></span>
                            <label for="product_name"> : اسم المنتج </label>
                            <input style="display: none;" value="<?php echo e($product->name_ar); ?>" class="form-control" id="product_name" name="product_name">
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('site.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zeus-website\resources\views/site/pages/ar/product_ar.blade.php ENDPATH**/ ?>