                            ...
                            <table class="display datatables" id="ajax-data-object">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo e(__('main.Order_Number')); ?></th>
                                     <th><?php echo e(__('main.Client_Name')); ?> </th>
                                      <th><?php echo e(__('main.Status')); ?> </th>
                                    <th>  <?php echo e(__('main.Order_Total')); ?></th>
                                    <th>  <?php echo e(__('main.Payment_Status')); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.default-layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\.well-known_2\resources\views/admin/order/index.blade.php ENDPATH**/ ?>