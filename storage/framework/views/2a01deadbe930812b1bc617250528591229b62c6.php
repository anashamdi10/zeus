	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
				...
				<button type="button" class="btn btn-primary py-3 px-5" data-toggle="modal" data-target="#staticBackdrop">
					Order Now
				</button>
			</div>
		</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('site.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\woody-factory\resources\views/site/pages/products_item.blade.php ENDPATH**/ ?>