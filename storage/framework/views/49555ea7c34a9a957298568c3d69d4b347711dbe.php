<div class="page-main-header">
  <div class="main-header-right row m-0">
    <div class="main-header-left">
      ...
      <div class="dark-logo-wrapper"><a href="<?php echo e(route('admin.dashboard')); ?>"><img class="img-fluid" src="<?php echo e(asset('assets/images/logo/dark-logo.png')); ?>" alt=""></a></div>
      ...
      <ul class="nav-menus">
        ...
        <!-- <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              <small>
            <?php echo e(trans('main.current_lang')); ?>

            </small>
          </a>
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" hreflang="ar"  href="<?php echo e(LaravelLocalization::getLocalizedURL('ar', null, [], true)); ?>">العربيه</a></li>
            <li><a class="dropdown-item" hreflang="en"  href="<?php echo e(LaravelLocalization::getLocalizedURL('en', null, [], true)); ?>">En </a></li>
          </ul>
        </li> -->
      </ul>
    </div>
...
<?php /**PATH /home/s2758queo60r/zeus-ex.com/resources/views/layouts/default-layout/partials/header.blade.php ENDPATH**/ ?>