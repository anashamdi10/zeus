...
<h3>Our services Edit / <?php echo e($info->title_en); ?> </h3>
<?php $__env->endSlot(); ?>
        ...
        <div class="col-sm-12 col-xl-12">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action=<?php echo e(route('services.update',$info->id)); ?> method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    <img src="<?php echo e(asset('uploads/services/' . $info->image)); ?>" width="80px" height="80px" style="margin-bottom: 10px; " /> <br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.default-layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/s2758queo60r/zeus-ex.com/resources/views/admin/our_services/edit.blade.php ENDPATH**/ ?>