        ...
        <div class="bg-primary b-r-4 card-body">
          <div class="media static-top-widget">
            ...
            <div class="media-body"><span class="m-0"><?php echo e(__('main.Orders')); ?></span>
              <h4 class="mb-0 counter"><?php echo e($orders); ?></h4><i class="icon-bg" data-feather="shopping-bag"></i>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="user-status table-responsive">
            <table class="table table-bordernone">
              ...
              <tbody>
                <?php $__currentLoopData = $orders_table; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
          ...
          <div class="user-status table-responsive">
            <table class="table table-bordernone">
              ...
              <tbody>
                ...
                <tr>
                  <td class="f-w-600">
                    <?php echo e($shortage->product_code); ?>

                  </td>
                  <td class="f-w-600">
                    <?php echo e($shortage->name_en); ?>

                  </td>
                  <td><?php echo e($shortage->harvest_sessions); ?></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default-layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/s2758queo60r/zeus-ex.com/resources/views/admin/index.blade.php ENDPATH**/ ?>